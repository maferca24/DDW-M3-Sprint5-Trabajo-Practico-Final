...
// import paisesRoutes from './routes/superHeroesRoutes.mjs';
// import paisesRoutefront from './routes/superHeroFront.mjs';
//Nuevas rutas- API y Frontend
import superHeroRoutes from './routes/paisesRoutes.mjs';// Importar las rutas de la API para paises
import heroesroutefront from './routes/paisesFront.mjs';// Importar las rutas del frontend para paises
